...
class ICMS70 extends \Sped\Components\Xml\Element  {
    ...
    public function addCST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMS70\CST(self::CST, $value), true);
    }
    ...
    public function addModBC($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMS70\ModBC(self::MODBC, $value), true);
    }
    ...
    public function addModBCST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMS70\ModBCST(self::MODBCST, $value), true);
    }
