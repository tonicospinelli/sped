...
class ICMSPart extends \Sped\Components\Xml\Element  {
    ...
    public function addCST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMSPart\CST(self::CST, $value), false);
    }
    ...
    public function addModBC($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMSPart\ModBC(self::MODBC, $value), false);
    }
    ...
    public function addPRedBC($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TDec_0302Opc(self::PREDBC, $value), false);
    }
    ...
    public function addModBCST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMSPart\ModBCST(self::MODBCST, $value), false);
    }
    ...
    public function addPBCOp($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TDec_0302Opc(self::PBCOP, $value), false);
    }
    ...
    public function addUFST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TUf(self::UFST, $value), false);
    }
