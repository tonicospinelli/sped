...
class ICMSSN201 extends \Sped\Components\Xml\Element  {
    ...
    public function addCSOSN($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\CSOSN(self::CSOSN, $value), true);
    }
    ...
    public function addModBCST($value = NULL){
        return $this->appendChild(new \Sped\Schemas\V200\TNFe\InfNFe\Det\Imposto\ICMS\ICMSSN201\ModBCST(self::MODBCST, $value), true);
    }
